...
export default function GameGridStakeCard({stake, isSelected, onClick}: GameGridStakeCardProps) {
    const {stakeColor, backgroundColor, selectedBackgroundColor, borderColor} = stake;
    ...
    return (
        <Button variant="outlined"
                ...
                sx={{
                    padding: 0,
                    backgroundColor: isSelected ? selectedBackgroundColor ?? backgroundColor : backgroundColor,
